...
import com.example.tp_voley.Adapter.MyAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Ajoutez le code suivant pour gérer le clic sur le bouton "Add Student"
        Button addButton = findViewById(R.id.backButton);
        addButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Redirigez l'utilisateur vers l'activité "AddEtudiant"
    ...
    private void fetchStudentsFromServer() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, fetchUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                studentAdapter = new MyAdapter(MainActivity.this, students);
